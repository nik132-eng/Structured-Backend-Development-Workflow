...
5. Check that no secrets, tokens, or personal/patient data have leaked into task-folder docs, progress logs, or learnings files — these are persisted and often committed; flag any leak as critical.
6. If there are no findings, say so explicitly.
